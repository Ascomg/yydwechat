...
SKY.CarouselItem.prototype = {
    ...
    update: function() {
        var a = this.carousel.settings;
        if (SKY.Utils.has2dTransformationSupport()) a = "translate(" + this.x + "px, " + this.y + "px) scale(" + this.scale + ")",
...
SKY.Carousel.prototype = {
    ...
    //     this.select(b + 1, a)
    //     // var zh=document.getElementById("zh_imgbox").getElementsByTagName("li").getAttribute("data-id");
    //     // var zh = b.attr("data-id");
    ...
    update: function() {
        ...
        b = this.settings,
        c = this.container,
        d = c.getLeft(), g = [], f = 0; f < this.carouselItems.length; f++) {
...
window.Modernizr = function(a, b, c) {
    ...
    w = function(a, c, d, e) {
        ...
        (n ? l: m).innerHTML += f,
        m.appendChild(l),
        n || (m.style.background = "", m.style.overflow = "hidden", p = h.style.overflow, h.style.overflow = "hidden", h.appendChild(m)),
        g = c(l, a),
    ...
    k.touch = function() {
        var c;
        return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : w(["@media (", l.join("touch-enabled),("), "modernizr){#modernizr{top:9px;position:absolute}}"].join(""),
        function(a) {
            c = 9 === a.offsetTop
        }),
        c
