...
public class Const
{
        ...
        public static final String NO_INTERCEPTOR_PATH =".*/((.css)|(.js)|(images)|(login)|(exit)|(getDetails)|(imgs)|(draw_details.html)|(callback)).*";

        public static final String DRAW_PATH ="(/draw/getDetails)|(/draw/getNews)";
